            ...
            <div className="flex justify-between items-center">
                ...
                <CreateBackupDialog
                    ...
                    onCreate={(name, containerOnly, optimizedStorage) =>
                        onCreate(name, containerOnly, optimizedStorage).catch((e: any) => setActionError(e.message))
                    }
                />
            </div>
                        ...
                        {isLoading ? (
                            ...
                            backups.map((backup) => (
                                <BackupRow
                                    key={backup.name}
                                    backup={backup}
                                    onDelete={() => onDelete(backup.name).catch((e: any) => setActionError(e.message))}
                                    onRename={(newName) => onRename(backup.name, newName).catch((e: any) => setActionError(e.message))}
